...
class CalendarioAlumnoFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        uid?.let {
            calendarioViewModel.cargarEventosAlumno(it)
   ...
   /* private fun setupRecyclerView() {
    ...
    private fun setupCalendar() {
        ...
        binding.calendarView.dayBinder = object : MonthDayBinder<DayViewContainer> {
            ...
            override fun bind(container: DayViewContainer, day: CalendarDay) {
                ...
                val eventos = calendarioViewModel.eventosAlumno.value?.filter { it.fecha == dateTimestamp } ?: emptyList()
    ...
    private fun actualizarListaEventos() {
        val eventos = calendarioViewModel.eventosAlumno.value?.filter { it.fecha == selectedDate } ?: emptyList()
